...
<div class="row" style="margin-top:-12px;">
	<h5 class="page-header" style="color:blue;"><i class="fa fa-cog"></i> Navigation Parent Settings</h5>
</div>
	...
	<div class="col-lg-12">
		...
		<div class="panel panel-default" style=" font-size: 12px;">
			...
			<div class="panel-body tab-content" style="height: auto;background-color: white;">
				...
				{{ Form::open(array('route' => array('post.navigation.parent'))) }}

			 	<table class="table table-bordered" style="width: 100%;margin-top: 10px;" id="table_parent">
			 		<thead>
			 			<tr style="font-weight: bold;">
			 				<td>WINDOW CODE</td>
			 				<td style="width: 200px;">WINDOW CLASS</td>
			 				<td>NAV DESCRIPTION</td>
			 				<td style="width: 200px;">ICON</td>
			 				<td style="width: 80px;">CHILD</td>
			 				<td style="width: 250px;">ROUTE</td>
			 				<td style="width: 80px;">ORDER</td>
			 				<td style="width: 40px;"><i class="fa fa-trash" style="color:red;"></i></td>
			 			</tr>
			 		</thead>
                                   ...
                                   <tr id="trList">
									   ...
									   <td style="padding: 0px;">
                                        ...
                                        <td style="padding:0px;">
                                            ...
                                            <select name="window_class[]" class="form-control" >

                                                <option value="A"  @if($element['WINDOW_CLASS'] == 'A') selected @endif>Activity</option>
                                                <option value="R"  @if($element['WINDOW_CLASS'] == 'R') selected @endif>Reports</option>
                                                <option value="TM" @if($element['WINDOW_CLASS'] == 'TM') selected @endif>Masterfile</option>
                                                <option value="AM" @if($element['WINDOW_CLASS'] == 'AM') selected @endif>Application Manager</option>
                                                <option value="SC" @if($element['WINDOW_CLASS'] == 'SC') selected @endif>System Control</option>
...
@include('POS.app_manager.navigation.scripts.navigation_parent_script')
