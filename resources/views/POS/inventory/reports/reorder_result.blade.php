<?php use App\Http\Traits\inventory\ReorderTraits;
...
$data_count = ReorderTraits::countData($brand,$type);
...
@endphp
		...
		<div id="print" style="width: 800px;height: 1100px; margin: auto;background-color: #fff;margin-bottom: 50px;">
			...
			<div class="container" style="width: 100%;">
				...
				<table align="center" style="width: 100%;border:1px solid black;font-size:13px;margin-top: -15px;" id="page_header2">
					<tr>
						...
						<td style="border-right: 1px solid black;">Inventory Reorder Report</td>
				...
				<p style="font-weight: bold;font-size: 13px;padding: 10px;;">Below are items that's in minimum level or reorder level.</p>
				</div>
			...
			<table style="width: 770px" style="border-bottom: 1px solid black;">
				...
				<tbody>
				@php
					$data_list = ReorderTraits::getData($brand, $type , $skip, 50);
				@endphp
