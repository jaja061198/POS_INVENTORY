...
$count = SalesReportController::getDailyData($date_sort);
...
@endphp
		...
		<div id="print" style="width: 800px;height: 1100px; margin: auto;background-color: #fff;margin-bottom: 50px;">
			...
			<div class="container" style="width: 100%;">
				...
				<p style="font-weight: bold;font-size: 13px;padding: 10px;;">Sales Report for the day of {{ date('M-d-Y', strtotime($date_sort)) }}</p>
				</div>
			...
			<table style="width: 770px" style="border-bottom: 1px solid black;">
				...
				<tbody>
					...
					@php
						$data_list = SalesReportController::retrieveDailyData($date_sort, $skip, 50);
					@endphp}
				...
				<tr style="font-size: 12px;font-family: calibri;font-weight: bold;border: 1px solid black;background-color: yellow;">
					...
					<td style="text-align: right;">{{ Helper::numberFormat(SalesReportController::getTotalDiscount($date_sort)) }}</td>
				<tr>
					
				<tr style="font-size: 12px;font-family: calibri;font-weight: bold;border: 1px solid black;background-color: yellow;">
					<td colspan="4"></td>
					<td>Total Sales: </td>
					<td style="text-align: right;">{{ Helper::numberFormat($total - SalesReportController::getTotalDiscount($date_sort)) }}</td>
				<tr>
